export default function PerksLabel({selected,onChange}){
    ...
    return(
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <div>
                    <label className="border p-4 rounded-2xl flex gap-2 items-center">
                        <input type="checkbox"  checked={selected.includes("sutta")}  name="sutta" onChange={handleCbClick} />
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <div>
                    <label className="border p-4 rounded-2xl flex gap-2 items-center">
                        <input type="checkbox" checked={selected.includes("long-term")} name="long-term"  onChange={handleCbClick} />
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
